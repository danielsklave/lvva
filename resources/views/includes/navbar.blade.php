<!-- Navigation -->
<nav>
    <div class="flex justify-between items-center px-4 md:px-6 py-4 md:my-2">
...
<nav class="p-4 md:p-2 bg-sky-800">
  <div class="flex flex-wrap items-center">
    ...
    <div class="hidden w-full md:block md:w-auto" id="navbar-solid-bg">
      <ul class="mx-2 flex flex-col mt-4 bg-sky-800 md:flex-row md:space-x-1 md:mt-0 md:font-medium md:bg-transparent">
        <li class="nav-item dropdown">
          ...
          <div id="dropdownNavbar1" class="hidden z-10 w-44 font-normal bg-white rounded divide-y divide-gray-100 shadow">
            <ul class="py-1 text-sm text-gray-700" aria-labelledby="dropdownLargeButton1">
              ...
              <li>
                <a href="{{ route('about.board') }}" class="block py-2 px-4 hover:bg-gray-100">
                  Valde
                </a>
              </li>
              <li>
                <a href="http://www.lvva.lv/nolikumi/22/LVVA%20biedru%20saraksts%20(10%2009%202022).pdf" class="block py-2 px-4 hover:bg-gray-100">
                  Juridiskie biedri
                </a>
              </li>
              <li>
                <a href="{{ route('user.categories') }}" class="block py-2 px-4 hover:bg-gray-100">
                  Biedru sapulces
                </a>
              </li>
              <li>
                <a href="{{ route('user.comments') }}" class="block py-2 px-4 hover:bg-gray-100">
                  Dokumenti
                </a>
              </li>
            </ul>
        ...
        <li>
        <li class="nav-item dropdown">
          <button id="dropdownNavbarLink2" data-dropdown-toggle="dropdownNavbar2" class="flex justify-between items-center py-2 px-4 text-white rounded hover:bg-sky-700 md:bg-transparent">
            Sacensības
            <svg class="ml-1 w-5 h-5" aria-hidden="true" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z" clip-rule="evenodd"></path></svg>
          </button>
          <!-- Dropdown menu -->
          <div id="dropdownNavbar2" class="hidden z-10 w-44 font-normal bg-white rounded divide-y divide-gray-100 shadow">
            <ul class="py-1 text-sm text-gray-700" aria-labelledby="dropdownLargeButton2">
              <li>
        ...
        <li>
        <li class="nav-item dropdown">
          <button id="dropdownNavbarLink3" data-dropdown-toggle="dropdownNavbar3" class="flex justify-between items-center py-2 px-4 text-white rounded hover:bg-sky-700 md:bg-transparent">
            Statistika
            <svg class="ml-1 w-5 h-5" aria-hidden="true" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z" clip-rule="evenodd"></path></svg>
          </button>
          <!-- Dropdown menu -->
          <div id="dropdownNavbar3" class="hidden z-10 w-44 font-normal bg-white rounded divide-y divide-gray-100 shadow">
            <ul class="py-1 text-sm text-gray-700" aria-labelledby="dropdownLargeButton3">
              <li>
                <a href="{{ route('dashboard') }}" class="block py-2 px-4 hover:bg-gray-100">
                  Rekordi
                </a>
        ...
        <li>
          <a href="#" class="block py-2 px-4 text-white rounded hover:bg-sky-700 md:bg-transparent">
            LVVA konkurss
          </a>
        </li>
        <li>
            ...
            <li class="nav-item dropdown">
                ...
                <div id="dropdownNavbar4" class="hidden z-10 w-44 font-normal bg-white rounded divide-y divide-gray-100 shadow">
                    <ul class="py-1 text-sm text-gray-700" aria-labelledby="dropdownLargeButton">
                      ...
                      <li>
                        <a href="{{ route('user.posts') }}" class="block py-2 px-4 hover:bg-gray-100">
                          Posts
                        </a>
                      </li>
                      <li>
